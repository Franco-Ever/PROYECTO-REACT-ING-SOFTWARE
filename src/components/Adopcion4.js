    ...
    return (
        <div className="container">
            ...
            <div className="tarjeta-equipo">
                <br />
            <h1 className="text-center fs-5">SAMBINHA</h1>
            <div className=" mb-3">
            <div className="row g-0">
                ...
                <div className="card-body texto-equipo">
                    ...
                    <p className="card-text fw-normal">Adulto / Nacimiento: 05/2009</p>
                    <p className="card-text">Raza:</p>
                    <p className="card-text fw-normal">Podengo</p>
                    <p className="card-text">Tamaño:</p>
                    <p className="card-text fw-normal">Medio</p>
                    <p className="card-text">Caracter:</p>
                    <p className="card-text fw-normal">Dócil</p>
                    <hr/>
                </div>
