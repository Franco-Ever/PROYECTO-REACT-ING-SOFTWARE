    ...
    return (
        <div className="container">
            ...
            <div className="tarjeta-equipo">
                <br />
            <h1 className="text-center fs-5">CHÉKERE</h1>
            <div className=" mb-3">
            <div className="row g-0">
                ...
                <div className="card-body texto-equipo">
                    ...
                    <p className="card-text fw-normal">Macho</p>
                    <p className="card-text">Edad:</p>
                    <p className="card-text fw-normal">Adulto / Nacimiento: 02/2015</p>
